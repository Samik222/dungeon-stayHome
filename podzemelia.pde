/* TODO:
 Сделать двери с ключом.
 Сделать красивые фоны/анимации типо того:Меню, победы, проигрыша...
 Cделать красивее текстуры, лучше звуки..
 Сделать ещё больше уровней.
 
 P.S. Есть тестовый уровень, там я тесчу игровые обьекты. Что-бы добавить этот уровень в игру. Зайдите в вкладку "levels".
 Перейдите на 102 строку, и добавьте этот уровень в память.
 */
